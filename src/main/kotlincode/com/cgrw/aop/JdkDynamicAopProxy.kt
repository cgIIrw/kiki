...
class JdkDynamicAopProxy(var advised: AdvisedSupport) : AopProxy, InvocationHandler {
    ...
    override fun getProxy(): Any? {
        return Proxy.newProxyInstance(advised.targetSource!!.target!!
                .javaClass.classLoader, advised.targetSource!!.targetClass, this)
    }
    ...
    override fun invoke(proxy: Any?, method: Method?, args: Array<Any>?): Any? {
        ...
        // 匹配时返回拦截器的处理方法
            ...
            // 不匹配时返回目标对象的原本方法
            return method?.invoke(advised.targetSource!!.target, *(args ?: arrayOfNulls<Any>(0)))
        }
    }
}